...
function process_way(profile, way, result, relations)
  ...
  if data.highway and profile.highway_blacklist and profile.highway_blacklist[data.highway] then
    return
  end

  local surface = way:get_value_by_key('surface')
  if surface and profile.surface_blacklist and profile.surface_blacklist[surface] then
    return
  end
